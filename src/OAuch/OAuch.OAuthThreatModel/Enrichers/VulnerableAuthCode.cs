...
namespace OAuch.OAuthThreatModel.Enrichers {
    public class VulnerableAuthCode : Enricher {
        ...
        public override ConsequenceType[] DependsOn => [ConsequenceTypes.AuthorizationCodeLeaked, ConsequenceTypes.SessionAuthenticationSidestepped, ConsequenceTypes.ClientAuthenticationSidestepped];
