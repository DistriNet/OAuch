...
namespace OAuch.Compliance.Tests.AuthEndpoint {
    public class UnrecognizedParameterAllowedTest : Test {
        public override string Title => "Does the authorization server ignore unrecognized parameters";
        public override string Description => "This test checks if the authorization server allows adding (unrecognized) parameters to the request. This can be important to support future extensions of the OAuth 2.0 protocol.";
