...
namespace OAuch.Compliance.Tests.TokenEndpoint {
    ...
    public class UnrecognizedParameterAllowedTestImplementation : TestImplementation {
        ...
        public async override Task Run() {
            ...
            var provider = flows.CreateProviderWithStage<GetClaimParameters, bool, Dictionary<string, string?>>(this.Context);
            if (provider == null) {
            ...
            provider.Pipeline.AddAfter<GetClaimParameters, bool, Dictionary<string, string?>>(processor);
