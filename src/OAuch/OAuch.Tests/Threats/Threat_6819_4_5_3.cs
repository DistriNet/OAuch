...
namespace OAuch.Compliance.Threats {
    public class Threat_6819_4_5_3 : Threat {
        public Threat_6819_4_5_3() {
            ...
            AddMitigation(Mit<RefreshTokenEntropyMinReqTest>(1), Mit<RefreshTokenEntropySugReqTest>(1), Mit<IsRefreshBoundToClientTest>(1), Mit<IsRefreshAuthenticationRequiredTest>(1));
        }
